...
#define UART_ITSource_ErrorOverflow UART_IMSC_OERIM_Msk /*!< Переполнение буфера приемника */
...
#define UART_Flag_RxFIFOEmpty UART_FR_RXFE_Msk /*!< Флаг пустоты буфера приемника */
#define UART_Flag_TxFIFOFull UART_FR_TXFF_Msk  /*!< Флаг заполнения буфера передатчика */
#define UART_Flag_RxFIFOFull UART_FR_RXFF_Msk  /*!< Флаг заполнения буфера приемника */
#define UART_Flag_TxFIFOEmpty UART_FR_TXFE_Msk /*!< Флаг пустоты буфера передатчика */
...
#define UART_Error_Overflow UART_RSR_OE_Msk /*!< Флаг переполнения буфера приемника */
