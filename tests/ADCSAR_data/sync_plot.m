...
%
%    filename: D:\workspace\perdolinque\IrisUNO-VG015\tests\ADCSAR\saw_1khz_3v_naive.csv
%
% Auto-generated by MATLAB on 05-Oct-2025 22:11:20
...
opts.VariableNames = ["CH0", "VarName2"];
...
opts = setvaropts(opts, "CH0", "TrimNonNumeric", true);
opts = setvaropts(opts, "CH0", "ThousandsSeparator", ",");

% Import the data
saw1khz3vnaive = readtable("D:\workspace\perdolinque\IrisUNO-VG015\tests\ADCSAR\saw_1khz_3v_naive.csv", opts);

%% Convert to output type
saw1khz3vnaive = table2array(saw1khz3vnaive);

%% Clear temporary variables
clear opts

signal = saw1khz3vnaive(:,2);
